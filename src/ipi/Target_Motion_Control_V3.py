...
class TargetMotionControlGUI:
    ...
    def animation_widgets(self):
        ...
        self.canvas = tk.Canvas(framing, width=1300, height=650, bg="black")
        ...
        self.speed_conversion = (30*7836.745406824146968503937007874)/(canvas_width*0.15)
        ...
        #buttons
        self.toggle_button1 = tk.Button(framing, text="Start Movement", bg="#43a047", fg="white", font=("Segoe UI", 12, "bold"), width=12, command=self.go_in)
        self.toggle_button1.grid(row=1, column=0, columnspan=2, padx=10, pady=10, sticky="ew")    

        self.toggle_button2 = tk.Button(framing, text="New Sample (Reset Exposure Time)", bg="#007acc", fg="white", font=("Segoe UI", 12, "bold"), width=12, command=self.new_exposure)
        self.toggle_button2.grid(row=5, column=0, columnspan=2, padx=10, pady=10, sticky="ew")

        self.toggle_button3 = tk.Button(framing, text="Return to Home Position & Reset Timer", bg="#e53935", fg="white", font=("Segoe UI", 12, "bold"), width=12, command=self.reset_all)
        ...
        self.toggle_button4 = tk.Button(framing, text="Set New Home Position", bg="#e53935", fg="white", font=("Segoe UI", 12, "bold"), width=12, command=self.rezero_pos)
